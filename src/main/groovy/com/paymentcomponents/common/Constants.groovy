...
class Constants {
    ...
    static final String SUCCESSFUL_REQUEST = "00"
    ...
    public enum ERROR_CODES {
        internal_error, invalid_request, institution_bank_not_found, instructed_bank_not_found, instructed_bank_url_not_found, constraint_violation, unknown_error, request_forward_error
    }
    ...
    public enum FINANCIAL_INSTITUTION_RESPONSE_CODE_VALUES {
        SUCCESSFUL_REQUEST
    }
}
